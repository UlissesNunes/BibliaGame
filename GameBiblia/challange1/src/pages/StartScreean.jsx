...
<>
  ...
  bg-gradient-to-b from-green-50  to-green-100 xl:align-middle xl:items-center">
    <h1 className="pt-6 pl-2 pr-2 text-center text-sm font-bold text-green-950  sm:text-lg md:text-lg md:w-4/5 lg:text-xl lg:px-20 lg:m-2 xl:px-44 xl:py-10 xl:align-middle xl:text-2xl  2xl:text-2xl 2xl:pt-24 2xl:px-40 2xl:mb-1">
    ...
    <p className="text-green-950 w-34 p-5 text-sm  text-center md:text-sm md:justify-center md:text-center  lg:text-lg lg:pb-20 xl:mb-20 xl:text-base   2xl:hidden">Tudo posso naquele que me fortalece - <br/><strong>Filipenses 4:13</strong></p>
