...
<>
  ...
  bg-gradient-to-b from-green-50  to-green-100 xl:align-middle xl:items-center">
    <h1 className="pt-6 pl-2 pr-2 text-center text-sm font-bold text-green-950  sm:text-lg md:text-lg md:w-4/5 lg:text-2xl xl:px-14 xl:py-10 xl:align-middle xl:w-2/3  2xl:text-3xl 2xl:pt-20">
