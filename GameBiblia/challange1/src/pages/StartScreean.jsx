...
<>
  <main className="flex flex-col items-center justify-start h-screen bg-green-50">
    ...
    <button className="mt-6 w-24 bg-green-950 text-white py-2 px-4 rounded-md cursor-pointer hover:bg-green-700 transition duration-300 font-bold">
      Iniciar
    </button>

    <img src="src/assets/FUNDOVERDE.png" alt="" className="w-auto mt-10 p-4"/>

    <p className="text-green-950 w-34 p-5 text-sm">Tudo posso naquele que me fortalece - <strong>Filipenses 4:13</strong></p>
  </main>
</> 
  )
}
