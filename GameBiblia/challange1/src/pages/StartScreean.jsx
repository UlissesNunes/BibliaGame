...
<>
  ...
  bg-gradient-to-b from-green-50  to-green-100">
    ...
    <button onClick={StartGameOn} className="mt-8 w-32 bg-green-800 text-green-50 hover:text-green-100 py-2 px-4 rounded-md cursor-pointer hover:bg-green-900 transition duration-300 font-bold">
      Iniciar jogo
    </button>
